        ...
        <>
          {!hasPaid ? (
            ...
            <>
              ...
              <KeepAlive />
              <Routes>
                {/* Static routes - Home and main pages */}
                ...
                {/* Static authentication and volunteer routes */}
                ...
                {/* News routes - static before dynamic */}
