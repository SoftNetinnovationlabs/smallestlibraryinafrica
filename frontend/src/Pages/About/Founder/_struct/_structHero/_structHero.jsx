    ...
    <div className="struct-hero">
      <div className="struct-hero-container">
        ...
        <div className="hero__-content">
          ...
          <h5>
            A Story of Resilience: The Journey of Cyril Otieno and the Smallest
            Library in Africa
          </h5>
          <div className="p_graph">
            <p>
              Cyril Otieno’s story is one of courage, perseverance, and an
              unyielding commitment to his community. Growing up in the Mugure
              slums of Kenya, Cyril faced a myriad of socio-economic challenges
              that could have easily deterred him from dreaming of a better
              future. Yet, it was these very hardships that fueled his
